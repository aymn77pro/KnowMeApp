...
fun providerGetOnePersonDataUseCase():GetOnePersonUseCase = GetOnePersonUseCase(providerPersonRepository())

fun providerSetOnePersonDataUseCase():SetOnePersoneData = SetOnePersoneData(providerPersonRepository())